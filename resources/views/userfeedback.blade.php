...
@section('content')
	...
	<form method="POST" action = "userfeed">
                ...
                <input type="text"  required name="id" value="{{$user->id}}" style="position: relative;left: 72px"><br>
                <label style="position: relative;left: 10px"  style="position: relative;left: 70px">Email</label>
                <input type="email" required name="email" value="{{$user->email}}" style="position: relative;left: 48px"><br>
